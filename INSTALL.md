...
這份文件假設你**剛裝好 Windows，什麼都沒裝**，跟著做完，你的家人就能在 iPhone / Android / iPad 上練 **6,255 字英文單字** (Level 1–6，每級約 1,000 字，字庫已預先打包在 repo 裡)，跨裝置自動同步。
...
右上角 **Level 下拉選單**，從 Level 1 (最簡單) 到 Level 6。每級約 1,000 字，合計 6,255 字，字庫已內建在程式碼裡，不用自己準備。
